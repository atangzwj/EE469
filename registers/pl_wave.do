...
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/ALUSrc
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/MemToReg
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/RegWrite
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/MemWrite
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/MemRead
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/ChooseImm
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/xferByte
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/ChooseMovk
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/ChooseMovz
add wave -noupdate -expand -group {Output Control} /pipelineRegs_testbench/ALUOp
